...
## Pulls out the fixed and random effects from a covariate string
## 
## Args:
##   covariate string: a string (without the outcome part) of lm or lmer form,
##                     e.g., "~ 1 + X1 +X2 + X1:X2 + (Z|X1)"
## Returns:
##   a list with:
##      fixef: a list of the fixed effects. Each element of the list is a vector,
##             with as many elements as there are interacting variables.
##             So for the example above, the 4th element of this list would be
##             a vector of length 2, containing "X1" and "X2".
##
##      ranef: a list of the random effects. each element of the list itself a list:
##             group: the grouping variable for each random effect term. e.g.,  X1 above
##             components: a vector of the variables grouped for this random effect: e.g., Z above
##      
