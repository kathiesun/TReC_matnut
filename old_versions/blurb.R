...
##fit box cox
getBestParArgs <- function(batchSize=100, mem.gb = 4, timeLimit.hours = 23, onCluster=T, system.type="killdevil")
{
    if(onCluster)
    {
        parallelArgs = list(system.type     = system.type,
                            filesToSource   = file.path("..","..","..","..","source_ks","matnut_src","lmer_functions_rna.R"),
                            batchSize       = batchSize,
